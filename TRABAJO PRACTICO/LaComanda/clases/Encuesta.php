...
class Encuesta
{
	...
	public $comentario;  
	  ...
	  public static function traerEncuesta()
	  {
			  ...
			  $consulta =$objetoAccesoDato->RetornarConsulta("select id,resto as PuntajeDelResto, cocinero as PuntajeCocinero , mozo as PuntajeMozo , comentario  from encuesta");
			  $consulta->execute();			
