...
class PedidoPuesto  
{
	...
	public static function existeAsignacionProd($pedido,$empleado,$prod){
	  ...
	  public static function asignacion($pedido,$empleado,$prod){
        $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		$consulta = $objetoAccesoDato->RetornarConsulta("INSERT INTO pedido_puesto (idPedido,idEmpleado,idProducto) values('$pedido','$empleado','$prod')");
		return $consulta->execute();	
	  }

      public static function reasignar($pedido,$empleado,$prod){
        $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		$consulta = $objetoAccesoDato->RetornarConsulta("UPDATE pedido_puesto set idEmpleado = '$empleado'  where idPedido = '$pedido' and idProducto = '$prod'");        
        return $consulta->execute();	
      }
