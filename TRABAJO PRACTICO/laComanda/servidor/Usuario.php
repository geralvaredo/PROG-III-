<?php 
include("laComanda/clases/AccesoDatos.php");
class Usuario 
{
    public $email ;
    public $clave ;
	...
	public static function traeIdPass($id){
        $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
        $consulta =$objetoAccesoDato->RetornarConsulta("select `id` from `usuario` where `id` = '$id'");
        $consulta->execute();
        return $miUsuario = $consulta->fetchAll();
    ...
    public static function borrarUsuario($id){
     ...
     public static function clienteHorarios(){
        $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
        $consulta =$objetoAccesoDato->RetornarConsulta("select * from v_clientes");
        $consulta->execute();			
